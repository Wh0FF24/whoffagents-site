        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold text-white leading-tight mb-5">
              Ready to hire your<br className="hidden md:block" /> first AI employee?
            </h2>

            <p className="text-gray-400 text-base leading-relaxed mb-8 max-w-xl mx-auto">
              Answers every inbound call, qualifies the job, books the appointment — 24/7,
              while you're on-site. Built for HVAC, plumbing, electrical, and pest control.
            </p>

            {/* Guarantee badge — sits directly above CTA */}
            <Link
              to="/refund-policy"
